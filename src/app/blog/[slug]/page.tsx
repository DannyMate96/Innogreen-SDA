...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const ogImage = post.image ?? "https://innogreen.net.au/opengraph-image";
...
export default async function BlogPostPage({ params }: Props) {
  ...
  const articleJsonLd = {
    ...
    headline: post.title,
    description: post.description,
    image: post.image ?? "https://innogreen.net.au/opengraph-image",
    author: {
      "@type": "Organization",
      name: "Innogreen",
    ...
    publisher: {
      ...
      logo: {
        "@type": "ImageObject",
        url: "https://innogreen.net.au/opengraph-image",
      },
    },
    ...
    mainEntityOfPage: {
      "@type": "WebPage",
      "@id": `https://innogreen.net.au/blog/${slug}`,
    },
    url: `https://innogreen.net.au/blog/${slug}`,
    inLanguage: "en-AU",
